 ...
 */
class TokenCreateOnlineData implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $brand, string $callMethod)
    {
        $this->brand = $brand;
    ...
    /**
     * Converts the TokenCreateOnlineData object to a human-readable string representation.
     *
     * @return string The string representation of the TokenCreateOnlineData object.
     */
    ...
    protected $propertyNames = ['brand', 'call_method', 'os_type', 'user_identifier', 'user_identifier_source'];
