 ...
 */
class SubscriptionListItem implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function getUserData(): ?SubscriptionUserData
    {
     ...
     * @maps user_data
     */
    public function setUserData(?SubscriptionUserData $userData): void
    {
        $this->userData = $userData;
    }

    /**
     * Converts the SubscriptionListItem object to a human-readable string representation.
     *
     * @return string The string representation of the SubscriptionListItem object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->nextPaymentDate)) {
            $json['next_payment_date']               = DateTimeHelper::toSimpleDate($this->nextPaymentDate);
        }
